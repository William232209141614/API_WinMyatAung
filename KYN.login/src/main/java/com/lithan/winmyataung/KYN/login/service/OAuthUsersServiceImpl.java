...
import com.lithan.winmyataung.KYN.login.oauth2users.OAuth2Users;
import com.lithan.winmyataung.KYN.login.oauth2users.OAuth2UsersFactory;
...
public class OAuthUsersServiceImpl extends DefaultOAuth2UserService{
    ...
    private Users registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2Users oAuth2Users) {
        ...
        user.setName(oAuth2Users.getName());
